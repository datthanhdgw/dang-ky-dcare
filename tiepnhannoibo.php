...
// Tìm tên trung tâm theo storeId
$selectedCenterName = '';
...
<div class="container mt-4">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form method="post" action="queuenoibo.php" onsubmit="saveCenterCookie()">
                <!-- Trung tâm bảo hành -->
                <div class="mb-3">
                    ...
                    <input type="hidden" name="center" value="<?= htmlspecialchars($selectedCenter) ?>">
                ...
                <button type="submit" class="btn btn-success w-100">✅ Đồng ý & đăng ký</button>
            </form>
        </div>
    </div>
</div>
